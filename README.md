...
| Admin dashboard | Role-gated area: list/view/edit/delete users, change roles, platform stats, and a gig-moderation table (list every gig, delete any). Create/delete actions across the app confirm with a toast. | carlaugu (#113); _core_ |
