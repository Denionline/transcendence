...
| FT_API_CALLBACK_URL | yes      | backend             | Redirect URI registered with the 42 app; must match the callback route exactly (`http://localhost:9000/auth/42/callback` in dev) |
